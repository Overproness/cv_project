...
Phase 1 specifically de-risked the question: _can the encoder→decoder→rasterizer pipeline learn to reconstruct faces from reference images at all?_ The answer is yes.
...
_Evaluated on `best.pt` at step 139,400 (training loss 0.0557)._
